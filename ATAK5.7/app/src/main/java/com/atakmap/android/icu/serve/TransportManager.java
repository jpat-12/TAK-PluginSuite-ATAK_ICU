...
public class TransportManager implements CapturePipeline.Sink {
    ...
    /** Transports still registered — {@link #startAll} drops any that failed to start.
     *  Zero means nothing is being published, however healthy the encoder looks. */
    public int activeCount() { return transports.size(); }
