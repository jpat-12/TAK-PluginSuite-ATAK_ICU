...
// 5.7 dropped the com.atakmap.android.video.ConnectionEntry shim; the class now lives
// only under gov.tak.api.video (VideoXMLHandler's signatures moved with it).
